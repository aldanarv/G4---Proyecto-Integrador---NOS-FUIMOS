                    ...
                    <div>
                        ...
                        <div className="mx-auto max-w-2xl px-4 pb-16 pt-5 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
                            <div className="lg:col-span-2 lg:pr-8">
                                <h1 className="text-xl font-bold tracking-tight text-black sm:text-2xl">{data?.destino}</h1>
                            </div>

                            <div className="mt-4 lg:row-span-3 lg:mt-0 p-6 rounded-md bg-white shadow-md">
                                <div className="flex items-end gap-2">
                                    <p className="text-xl tracking-tight text-black">${data?.precio} USD</p>
                                ...
                                <form className="mt-10">
                                    <div className="mt-10">
                                        <fieldset className="mt-4 border border-gray-300 rounded-md">
                                            <div className="grid grid-rows sm:grid-cols-2">
                                                <div className="p-3 sm:border-r sm:border-gray-300">
                                                ...
                                                <div className="p-3 border-t border-gray-300 sm:border-t-0">
