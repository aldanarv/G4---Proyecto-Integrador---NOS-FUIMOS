        ...
        <article className={styles.article}>
            <section className={styles.info}>
                <div className={styles.title}>
                    <p className={styles.title_h2}>Detalles de su reserva</p>
                ...
                <div className="bg-[#fffaf5] rounded-2xl">
                    <div>
                        <div className="mx-auto px-4 pb-16 pt-5 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:px-8 lg:pb-24 lg:pt-16">
                            <div className="lg:col-span-2 lg:pr-4">
                                <h1 className="text-3xl font-semibold text-orange-700 sm:text-2xl">{data?.nombre}</h1>
                            </div>
                            ...
                            <div className="mt-4 lg:row-span-3 lg:mt-0 p-4 sm:p-6 rounded-md bg-white shadow-md">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input type="text" name="nombre" value={formData.nombre} readOnly className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500" />
                                    </div>
                                    <div>
                                        <label htmlFor="apellido" className="text-sm font-semibold text-gray-600">Apellido</label>
                                        <input type="text" name="apellido" value={formData.apellido} readOnly className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500" />
                                    </div>
                                </div>
                                <div className="mt-4">
                                    <label htmlFor="email" className="text-sm font-semibold text-gray-600">Email</label>
                                    <input type="email" name="email" value={formData.email} readOnly className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:border-indigo-500" />
                                </div>
                                </form>
