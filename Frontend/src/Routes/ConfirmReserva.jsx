        ...
        <article>
          <div className='flex flex-col sm:flex-row gap-4 items-center sm:items-start'>
            ...
            <div className='text-center sm:text-start'>
              <h2 className='text-2xl sm:text-4xl text-[#DE8716] font-semibold'>¡Reserva realizada exitosamente!</h2>
          ...
          <div className='mt-8'>
            <div className="flex flex-col items-center justify-center gap-1">
              <Link to={"/history"} className='underline text-base text-[#DE8716] mt-5'>
                Historial reservas
              </Link>
            </div>
          </div>
